  ...
  level({
    ...
    steps: [
      ...
      basic({
        ...
        setup: {},
        toPlay: BLACK,
        goal: { type: 'point', accept: ['D4', 'K4', 'Q4', 'D10', 'K10', 'Q10', 'D16', 'K16', 'Q16'] },
      ...
      variant({
        ...
        toPlay: BLACK,
        goal: { type: 'point', accept: ['K4', 'D10', 'K10', 'Q10', 'K16'] },
        comments: {
